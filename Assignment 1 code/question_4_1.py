...
print('WordTagDictionary is ')
print(WordTagDictionary)
print('tagUniGramDictionary is ')
print(tagUniGramDictionary)
print('tagBiGramDictionary is ')
print(tagBiGramDictionary)