...
def emissionProbability(givenWord, givenTag, WordTagDictionary, tagUniGramDictionary):
    wordTagKey = givenWord + '/' + givenTag
    probability = float(WordTagDictionary[wordTagKey])/float(tagUniGramDictionary[givenTag])
    return probability
...
#prints the transition probability of at followed by nn
print(transitionProbability('at', 'nn', tagUniGramDictionary, tagBiGramDictionary))

#printd the emission probability
print(emissionProbability('The', 'at', WordTagDictionary, tagUniGramDictionary))